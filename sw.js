...
const urlsToCache = [
  ...
  '/bettynails/utils/push-config.js',
  '/bettynails/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/bettynails/icons/icon-192x192.png',
    badge: '/bettynails/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/bettynails/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/bettynails/admin.html';
  event.waitUntil(
